...
import de.bewerbungsatze.auth.AuthService;
import de.bewerbungsatze.auth.dto.AuthDtos.TokenResponse;
import de.bewerbungsatze.common.security.SecurityUtil;
...
public class OrgController {
    ...
    public record MemberView(UUID userId, String email, OrgMemberRole role, java.time.Instant joinedAt) {
        ...
        static MemberView fromUser(de.bewerbungsatze.users.User user, OrganizationMember member) {
    ...
    public List<MemberView> members(@PathVariable UUID orgId) {
        ...
        List<de.bewerbungsatze.users.User> users = service.listOrgUsers(orgId, userId);
