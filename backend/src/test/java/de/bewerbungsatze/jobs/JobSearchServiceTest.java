...
class JobSearchServiceTest {
    ...
    private final JobSearchService service = new JobSearchService(
            mock(de.bewerbungsatze.profile.ProfileRepository.class),
            mock(de.bewerbungsatze.profile.PreferencesRepository.class),
            mock(de.bewerbungsatze.cv.CvStructuredRepository.class),
